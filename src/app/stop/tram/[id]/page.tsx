  ...
  return (
    <div className='p-2'>
      <h1 className='text-2xl flex gap-2 items-center mb-3'>
        <Tram className='text-accent-content' />
        ...
        {passages.actual.map((p) => (
          <li key={p.vehicleId}>
            <div className='flex items-center gap-2 rounded p-2 bg-base-300 border border-neutral'>
              <div className='flex items-center justify-center text-xl tabular-nums font-bold p-3 bg-accent text-accent-content rounded w-16'>
                {p.patternText}
              </div>
              <div className='grow'>
